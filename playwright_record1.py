...
def run(playwright: Playwright) -> None:
    tickers = ["hims", "avgo", "upst", "sofi", "mrvl", "mdb", "mstr", "pltr"]
    download_dir = "/home/ben/pCloudDrive/stock/GEX/GEX_file/"

    browser = playwright.chromium.launch(headless=False)
    context = browser.new_context(storage_state="/home/ben/code/gex/ming_auth.json", viewport={"width":1920,"height":1080})
